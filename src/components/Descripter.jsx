...
const Descripter = ({ criterion, setApprove }) => {
  ...
  const handleApprove = (context, descripter, index) => {
    ...
    const valueA =
      ((60 / 100) * criterion.value) / criterion.listDescriptersArr.length;
    const valueB =
      ((20 / 100) * criterion.value) / criterion.listDescriptersArr.length;
    let rest =
      criterion.value / criterion.listDescriptersArr.length - (valueA + valueB);
